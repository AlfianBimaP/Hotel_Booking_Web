<!-- View Untuk menampilkan Form edit kamar oleh admin -->
...
<div class="col-lg-8">
    <form method="post" action="/dashboard/post/{{ $post->id}}" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('type') is-invalid @enderror" id="type" name="type" value="{{ old('type', $post->type) }}">
        @error('type')
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('nomor') is-invalid @enderror" id="nomor" name="nomor" value="{{ old('nomor', $post->nomor) }}">
        @error('nomor')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
